...
const char* ssid = "lolicon";  // insert your SSID
const char* password = "lolicon0620";  // insert your password
const char* host = "api.openweathermap.org";
const char* resource = "/data/2.5/weather?id=1665148&appid=591a4afd5efe720e558721907e2c77e5";
const char* IFFTTThost = "maker.ifttt.com"; //IFTTT server網址
const char* IFFTTTevent = "line_notify";  //IFTTT事件名稱
const char* IFFTTTapi = "2aZwimlqu13M-_fvwew5d";  //IFTTT Applet key 
...
void loop(){
  ...
  Senddeta(String (weather),String (temp),String (humidity));
    Serial.print("*** ");
...
void Senddeta(String value1, String value2, String value3){
  ...
  //Client連結Server
  if (client.connect(IFFTTThost, httpPort)) {
    
    //Webhook API
    url += "/trigger/" + String(IFFTTTevent) + "/with/key/" + String(IFFTTTapi);
    //Query String
    url += "?value1=" + value1 + "&value2=" + value2 + "&value3=" + value3;

    //Client傳送
    client.println(String("POST ") + url + " HTTP/1.1");
    client.println(String("host: ") + IFFTTThost); 
    client.println("Content-Type: application/json");
    client.print("Content-Length: ");
    client.println(JsonString.length());
    client.println();
